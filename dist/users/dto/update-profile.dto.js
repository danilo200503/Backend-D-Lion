...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Maria Silva', required: false }),
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdateProfileDto.prototype, "cargo", void 0);
__decorate([
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'https://cdn.dlion.com.br/avatars/user.png', required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
